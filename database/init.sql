...
CREATE TABLE IF NOT EXISTS simple_website.users (
...
CREATE TABLE IF NOT EXISTS simple_website.articles (
    `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS simple_website.users_articles (
